package com.classichu.dropselectview.adapter;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case TYPE_VIEW_NORMAL:
                view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_right_normal,parent,false);
                myRecyclerViewViewHolder=new MyRecyclerViewViewNormalHolder(view);
                break;
            case TYPE_VIEW_ALL:
                view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_right_all,parent,false);
