...
import com.classichu.dropselectview.adapter.MyRecylerViewLeftAdapter;
import com.classichu.dropselectview.adapter.MyRecylerViewOnlyOneAdapter;
import com.classichu.dropselectview.adapter.MyRecylerViewRightAdapter;
 ...
 */
public class ClassicSelectPopupWindow extends PopupWindow {

    private static final String TAG = "ClassicSelectPopWin";
        ...
        if (mOnlyOneList) {
            ...
            myRecylerViewOnlyOneAdapter.setOnItemClickListener(new MyRecylerViewOnlyOneAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View v, int pos) {
                    ...
                    ClassicSelectPopupWindow.this.dismiss();
                }
            });
